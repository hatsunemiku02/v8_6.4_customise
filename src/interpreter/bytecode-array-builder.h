...
class V8_EXPORT_PRIVATE BytecodeArrayBuilder final
 ...
 public:
  ...
  BytecodeArrayBuilder& ExtraLoadNumber(int32_t raw_smi);
  ...
  BytecodeArrayBuilder& ExtraCallRuntime(Runtime::FunctionId function_id, RegisterList args);
...
#undef DECLARE_OPERAND_TYPE_INFO
  ...
  template <typename... Operands>
  void ExtraOutputCallRuntime(Operands... operands);

  template <typename... Operands>
  void ExtraOutputCallRuntime(BytecodeLabel* label,Operands... operands);

  template <typename... Operands>
  void ExtraOutputInvokeIntrinsic(Operands... operands);

  template <typename... Operands>
  void ExtraOutputInvokeIntrinsic(BytecodeLabel* label, Operands... operands);
  ...
  void ExtraWrite(BytecodeNode* node);
